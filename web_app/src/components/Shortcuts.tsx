      ...
      <DialogContent>
        <DialogHeader>
          ...
          <Tabs className="pt-4" defaultValue="general">
            ...
            <TabsContent className="max-h-[80vh] space-y-2 overflow-y-auto pr-2" value="general">
            ...
            <TabsContent className="max-h-[80vh] space-y-2 overflow-y-auto pr-2" value="video">
              <ShortCut content="Previous exact frame" keys={["←"]} />
              <ShortCut content="Next exact frame" keys={["→"]} />
              <ShortCut content="Play / Pause" keys={["Space"]} />
            </TabsContent>
            <TabsContent className="max-h-[80vh] space-y-2 overflow-y-auto pr-2" value="image">
